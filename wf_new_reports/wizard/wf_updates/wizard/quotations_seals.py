...
class quotations_seals(models.TransientModel):
    ...
    products = fields.Many2many('product.product','pro_id','prod_cat_id',string="Products")
    ...
    def get_report(self):
        ...
        data = {
            ...
            'ids': self.ids,
            'form': {
                'date_start': self.date_start, 'date_end': self.date_end,'sales_person': self.sales_person.id,'category': pro,
            },
        }
